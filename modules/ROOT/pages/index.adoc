...
- Automatic generation of xref::queries-aggregations/queries.adoc[Queries].
...
- Options for xref::/directives/database-mapping.adoc[Database mapping].
...
. https://nodejs.org/en/[Node.js] 18+.
