...
- Extensibility through the xref::/type-definitions/directives/custom-logic.adoc#_cypher[`@cypher` directive] and/or xref::/type-definitions/directives/custom-logic.adoc#_custom-resolvers[Custom Resolvers].
- Extensive xref::queries-aggregations/filtering.adoc[Filtering] and xref::queries-aggregations/sorting.adoc[Sorting] options.
- Options for xref::/type-definitions/directives/database-mapping.adoc[Database mapping] and value xref::/type-definitions/directives/autogeneration.adoc[Autogeneration].
- xref::/queries-aggregations/pagination/index.adoc[Pagination] options.
- xref::/type-definitions/directives/security/index.adoc[Security options] and additional xref::schema-configuration/index.adoc[Schema Configuration].
