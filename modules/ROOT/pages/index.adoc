...
// I'm not sure if I understand what this paragraph is actually saying? Isn't it a little bit of a repetition from the previous paragraphs?//
...
- Comprehensive authentication and authorisation options (xref::authentication-and-authorization/index.adoc[Auth]), and additional xref::reference/directives/schema-configuration/index.adoc[Schema Configuration] options
