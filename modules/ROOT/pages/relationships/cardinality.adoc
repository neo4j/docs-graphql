...
The xref:#data-model[data model] represents represents the state of the graph in the database, but there are multiple ways to model the relationships in the GraphQL schema.
