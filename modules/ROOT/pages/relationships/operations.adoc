...
For asimilar mutation to <<top-level-delete-directed>> but with an `acquaintances` instead of `friends` relationship from Bob to Camilla, the outcome changes as follows:
