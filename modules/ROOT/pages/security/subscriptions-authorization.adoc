...
Filtering rules will prevent events which contain information that users don't have access to from ever reaching them - they will receive no indication that this is the case.
