...
* xref::/security/avoid-unbounded-queries.adoc[Avoid unbounded queries] - Strategies to prevent unbounded queries from reaching the server through mandatory limit arguments or evaluating the complexity of incoming queries.
