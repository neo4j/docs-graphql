...
This directive defines the filters generated for the field where this directive is applied.
It has two arguments:

* **byValue**: If disabled, this field will not generates value filters.
* **byAggregate**: If disabled, this field will not generates aggregation filters.
