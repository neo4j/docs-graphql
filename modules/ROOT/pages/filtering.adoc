...
Refer to xref:relationships/interfaces.adoc#_filtering_for_specific_implementations_of_an_interface[Relationships -> Interfaces] for more details and an example.
