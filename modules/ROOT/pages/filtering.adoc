...
See <<_spatial_type_filtering>> for more information.
...
Refer to xref:relationships/interfaces.adoc#_filtering_for_specific_implementations_of_the_interface[Relationships -> Interfaces] for more details and an example.
