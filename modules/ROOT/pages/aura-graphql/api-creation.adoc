...
+
. Once you are satisfied with the type definitions, select **Try out the API** to proceed to the next step where you can simulate GraphQL queries and mutations against the type definitions you have provided. Note that this while this does run against your database, it does not create a GraphQL API that can be used by applications until you have completed the final step of the creation process.
+
