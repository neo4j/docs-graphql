...
. Ensure you are connected to the Neo4j AuraDB instance with which you want to use the GraphQL API. The **Instance** drop-down at the top left shows your current connection.
...
+
If you already have data in the AuraDB, a quick way to obtain type definitions is to use the link:https://graphql-toolbox.neo4j.io[Neo4j GraphQL Toolbox].
The Neo4j GraphQL Toolbox has the ability to connect to an AuraDB, automatically create type definitions and allow GraphQL operations.
+
Alternatively you can write your own type definitions from scratch by following the guidance provided in xref:index.adoc[Neo4j GraphQL Library] documentation.
+
...
Alternatively, go **Back** to previous steps to make changes, or navigate away to exit without creating the API.
+
. API key
+
