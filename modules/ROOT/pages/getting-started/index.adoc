...
Note also how the `@node` directive is present on both `Movie` and `Actor` this is necessary to define them as Neo4j nodes.
...
In you Neo4j instance execute the following `Cypher`:
