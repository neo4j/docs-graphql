...
[NOTE]
====
Only changes made through `@neo4j/graphql` will trigger events. Changes made directly to the database or using the xref::/directives/cypher.adoc[`@cypher` directive] will **not** trigger any event.
====
