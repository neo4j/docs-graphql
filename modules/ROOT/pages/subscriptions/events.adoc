...
Changes made directly to the database or using the xref::type-definitions/directives/custom-logic.adoc#_cypher[`@cypher` directive] will **not** trigger any event.
====
