[[create]]
:description: This page covers how to apply filtering to subscriptions in the Neo4j GraphQL Library.
= Filtering

This page covers how to apply filtering to subscriptions in the Neo4j GraphQL Library.
Note, however, that:
