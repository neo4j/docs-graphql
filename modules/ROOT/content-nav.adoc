...
* xref:entity-and-connections-api.adoc[]
...
* xref:/relationships/index.adoc[]
** xref:/relationships/operations.adoc[Operations]
** xref:/relationships/cardinality.adoc[Cardinality and modeling relationships]
** xref:/relationships/single-relationships.adoc[Single relationships]
** xref:/relationships/interfaces.adoc[Interfaces]
** xref:/relationships/unions.adoc[Unions]
...
** xref:queries-aggregations/group-by.adoc[]
